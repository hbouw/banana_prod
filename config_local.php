...
define('DB_PORT', '54321'); //specifies port on which the postgres db is
define('DB_NAME', 'banana_test'); //specifies the postgres database name
...
define('DOWNLOAD_LAYER','cultivar_type');	//specifies the layer in GeoServer) that is to be downloaded 
